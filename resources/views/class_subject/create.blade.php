            ...
            <div class="modal-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-8 mx-auto text-center">
                        ...
                        <div class="form-group">
                            <input type="radio" name="color" id="magenta" value="#EAC4D5"/>
                            <label for="magenta" class="color"><span class="magenta"></span></label>
                            <input type="radio" name="color" id="orange" value="#FFC09F"/>
                            <label for="orange" class="color"><span class="orange"></span></label>
                            <input type="radio" name="color" id="yellow" value="#FFEE93"/>
                            <label for="yellow" class="color"><span class="yellow"></span></label>
                            <input type="radio" name="color" id="green" value="#33CC99"/>
                            <label for="green" class="color"><span class="green"></span></label>
                            <input type="radio" name="color" id="cyan" value="#99CCCC"/>
                            <label for="cyan" class="color"><span class="cyan"></span></label>
                            <input type="radio" name="color" id="blue" value="#809BCE"/>
