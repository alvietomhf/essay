<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow menu-border" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="{{ route('kelas-mapel.show', [$value->id]) }}"><i class="fa fa-square" style="color: {{ $value->color ?? '#666ee8' }}"></i><span class="menu-kelas" data-i18n="Kelas">{{ $value->clas->name }} - {{ $value->subject->name == 'Teknologi Informasi & Komunikasi' ? 'TIK' : $value->subject->name }}</span></a>
            </li>    
            @endforeach
            @endrole
        </ul>
