                            ...
                            <div class="row">
                                ...
                                <figure style="display: {{ $value->image ? 'block' : 'none' }};" class="col-lg-3 col-md-6 col-12" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="javascript:void(0);" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{  $value->image ? asset('storage/images/' . $value->image) : '' }}" itemprop="thumbnail" alt="Image description" style="border-style: none; padding: 0; background-color: transparent"/>
                                    </a>
                                </figure>
                            </div>
                            <div class="row mt-1">
